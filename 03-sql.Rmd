...
b. `intersect` - tuple in common btw 2 tables; automatically remove duplicates 
   ...
   - _ __INTERSECT ALL__ returns the _minimum_ number of duplicates in the 2 tables 
      
   
         Ex. So if 4 sections of ICP 101 were taught in Fall 2017 and 2 sections taught in Spring 2018, then there would be 2 tuples with ICP 101 in the resulting table 
$$\\[.1cm]$$       
